...
public class QueriesProvider {
     ...
     */
    static final String GET_ALL_SUBCATEGORIES = CTE_FOR_SUBCATEGORIES + """
    ...
    static final String GET_BOOKS_FROM_SUBCATEGORIES = CTE_FOR_SUBCATEGORIES + """
    ...
    static final String DELETE_CATEGORY_WITH_SUBCATEGORIES = CTE_FOR_SUBCATEGORIES + """
